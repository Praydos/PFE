...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <span class="zn-bc-sep">›</span>
        <span class="zn-bc-cur">Efficacité</span>
    </div>

    <div class="zn-header">
        <h1>Efficacité – NC {{ $non_conformite->numero }}</h1>
        <p>Ajoutez ou modifiez les informations d’efficacité pour cette non‑conformité.</p>
    </div>
            ...
            <div class="fp-section">
                <div class="fp-section-head">
                    ...
                    <div class="fp-section-meta">
                        ...
                        <div class="fp-section-sub">Contrôle, résultats et clôture</div>
                    </div>
                </div>

                {{-- Row 1: Mode de contrôle / Description du résultat (2 columns) --}}
                <div class="fp-row fp-row-2">
                    <div class="frm-group">
                        <label class="frm-label" for="mode_controle">Mode de contrôle</label>
                        <textarea name="mode_controle" id="mode_controle" rows="2"
                                  class="frm-textarea @error('mode_controle') is-invalid @enderror">{{ old('mode_controle', $non_conformite->mode_controle) }}</textarea>
                    ...
                    <div class="frm-group">
                        ...
                        <textarea name="description_resultat" id="description_resultat" rows="2"
                                  class="frm-textarea @error('description_resultat') is-invalid @enderror">{{ old('description_resultat', $non_conformite->description_resultat) }}</textarea>
                        @error('description_resultat')<span class="frm-error">{{ $message }}</span>@enderror
                    </div>
                </div>

                {{-- Row 2: Action efficace ? / Besoin d'action d'amélioration ? / Statut (3 columns) --}}
                <div class="fp-row fp-row-3">
                    <div class="frm-group">
                        <label class="frm-label" for="action_efficace">Action efficace ?</label>
                        <div class="frm-select-wrap">
                            <select name="action_efficace" id="action_efficace" class="frm-select @error('action_efficace') is-invalid @enderror">
                    ...
                    <div class="frm-group">
                        ...
                        <div class="frm-select-wrap">
                            <select name="besoin_action_amelioration" id="besoin_action_amelioration" class="frm-select @error('besoin_action_amelioration') is-invalid @enderror">
                                <option value="">-- Non spécifié --</option>
