...
@push('styles')
    ...
    <style>
        ...
        *::after {
        ...
        .fp-section-icon.blue {
            background: var(--blue-light);
            color: var(--blue);
        }

        .fp-section-icon.amber {
                ...
                <div class="fp-section">
                    ...
                    <div class="fp-row fp-row-2">
                        ...
                        <div class="frm-group">
                            ...
                            <div class="frm-select-wrap">
                                <select name="type" id="type" class="frm-select" required>
                                    ...
                                    <option value="personnelle" {{ old('type') == 'personnelle' ? 'selected' : '' }}>
                                        Personnelle (sans compte)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="frm-group" id="compte-group">
                            <label class="frm-label" for="compte_id">Compte <span class="req"
                                    id="compte-req">*</span></label>
                            <div class="frm-select-wrap">
                    ...
                    <div class="frm-group">
                        ...
                        <textarea name="description" id="description" class="frm-textarea" rows="2"
                            placeholder="Raison de la demande, informations complémentaires...">{{ old('description') }}</textarea>
                    </div>
                </div>
