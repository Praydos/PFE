            ...
            <form method="POST" action="{{ route('demandes-specimens.update', $demandes_specimen) }}" novalidate>
                ...
                <div class="zn-card-body">
                    ...
                    <div class="frm-group">
                        ...
                        <div class="frm-select-wrap">
                            <select name="type" id="type" class="frm-select" required>
                                ...
                                <option value="personnelle" {{ $demandes_specimen->type == 'personnelle' ? 'selected' : '' }}>
                                    Personnelle</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="frm-select-wrap">
                            <select name="compte_id" id="compte_id" class="frm-select" required>
                                ...
                                @foreach($comptes as $c)
                                    <option value="{{ $c->id }}" {{ $demandes_specimen->compte_id == $c->id ? 'selected' : '' }}>
                    ...
                    <div class="frm-group">
                        ...
                        <textarea name="description" id="description" class="frm-input"
                            rows="2">{{ old('description', $demandes_specimen->description) }}</textarea>
                    </div>
                    ...
                    <div id="products-container">
                        @foreach($demandes_specimen->lignes as $idx => $ligne)
                            <div class="product-row" data-id="{{ $ligne->id }}">
                                <div class="frm-group">
                                    ...
                                    <div class="frm-select-wrap">
                                        <select name="products[{{ $idx }}][product_id]" class="frm-select" required>
                                            ...
                                            @foreach($products as $p)
                                                <option value="{{ $p->id }}" {{ $ligne->product_id == $p->id ? 'selected' : '' }}>
                                ...
                                <div class="frm-group">
                                    ...
                                    <input type="number" name="products[{{ $idx }}][quantity]" value="{{ $ligne->quantity }}"
                                        class="frm-input" required min="1">
                                </div>
                                <input type="hidden" name="products[{{ $idx }}][id]" value="{{ $ligne->id }}">
                                <button type="button" class="btn-zn btn-zn-danger btn-zn-sm remove-product">X</button>
                            </div>
                        @endforeach
                    </div>
