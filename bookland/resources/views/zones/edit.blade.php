...
@push('styles')
{{-- Same <link> and <style> block as before --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadRbos(villeId, callback) {
        ...
        fetch(`/api/villes/${villeId}/rbos`)
            ...
            .then(data => {
                ...
                // After loading, try to restore the previously selected RBO (if any)
                if (callback) callback();
            })
            .catch(error => {
    ...
    villeSelect.addEventListener('change', function() {
        ...
        loadRbos(villeId, function() {
            // If we have a current RBO ID (from the zone), try to select it if it exists in the new list
