...
<div class="form-page">
    ...
    <div class="fp-header">
        ...
        <p>Mettez à jour les informations de <strong>{{ $contact->prenom }} {{ $contact->nom }}</strong>.</p>
    </div>
    ...
    <div class="fp-card">
        <div class="fp-card-header">
            ...
            <span class="fp-card-title">Informations du contact</span>
        </div>
        ...
        <form method="POST" action="{{ route('contacts.update', $contact) }}" novalidate>
            ...
            <div class="fp-footer">
                <a href="{{ route('contacts.index') }}" class="btn-fp btn-fp-ghost">
