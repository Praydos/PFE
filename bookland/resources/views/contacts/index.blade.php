...
@push('styles')
    ...
    <style>
        ...
        *::after {
        ...
        .dr-stat-card:hover::before {
            opacity: 1;
        }

        .dr-stat-card:nth-child(1) {
            animation-delay: .06s;
        }

        .dr-stat-card:nth-child(2) {
            animation-delay: .12s;
        }

        .dr-stat-card:nth-child(3) {
            animation-delay: .18s;
        }

        .dr-stat-card:nth-child(1)::before {
            background: var(--blue);
        }

        .dr-stat-card:nth-child(2)::before {
            background: var(--teal);
        }

        .dr-stat-card:nth-child(3)::before {
        ...
        .dr-table-scroll::-webkit-scrollbar {
            height: 4px;
        }

        .dr-table-scroll::-webkit-scrollbar-thumb {
        ...
        .av-b {
            background: linear-gradient(135deg, #0cb8b6, #00d4aa);
        }
        ...
        .av-e {
            background: linear-gradient(135deg, #e8506a, #ff6b9d);
        }
        ...
        .bd-teal {
            background: var(--teal-light);
            color: #0a9997;
            border-color: rgba(12, 184, 182, .2);
        }
    ...
    <div class="dr-page">
        ...
        <div class="dr-header">
            ...
            <div class="dr-header-actions">
                <a href="{{ route('contacts.printList', request()->query()) }}" target="_blank" class="btn-dr btn-dr-ghost">
        ...
        <div class="dr-search-bar">
            <form method="GET" action="{{ route('contacts.index') }}"
                style="display:flex;align-items:center;gap:.6rem;flex-wrap:wrap;width:100%;">
                <div class="dr-search-wrap">
                    <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <circle cx="11" cy="11" r="8" />
                        <line x1="21" y1="21" x2="16.65" y2="16.65" />
                    </svg>
                    <input type="text" name="search" class="dr-search-input" placeholder="Rechercher nom, email, téléphone…"
        ...
        <div class="dr-card">
            <div class="dr-card-header">
                ...
                <span class="dr-badge bd-blue">{{ $contacts->total() }}
                    contact{{ $contacts->total() > 1 ? 's' : '' }}</span>
            </div>
                            ...
                            <tr>
                                    ...
                                    <div class="user-cell">
                                        ...
                                        <div>
                                            ...
                                            <div class="user-name"><a
                                                    href="{{ route('contacts.show', $contact->id) }}">{{ $contact->prenom }}
                                                    {{ $contact->nom }}</a></div>
                                ...
                                <td>
                                    <div class="actions-cell">
                                        ...
                                        @if(auth()->user()->role === 'admin')
                                            <button class="btn-dr btn-dr-sm btn-dr-primary manage-comptes-btn"
                                                data-contact-id="{{ $contact->id }}"
                                                data-contact-name="{{ $contact->prenom }} {{ $contact->nom }}">
                                                <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.2"
                                                    viewBox="0 0 24 24">
                                    ...
                                    <td>
                                        <div class="actions-cell">
                                            ...
                                            <form action="{{ route('contacts.destroy', $contact) }}" method="POST"
                                                style="display:inline" onsubmit="return confirm('Supprimer ce contact ?')">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="dr-modal" role="dialog" aria-modal="true">
            ...
            <div class="dr-modal-body" id="modalCategoriesBody">
                <div class="dr-loading">
                    <div class="dr-spinner"></div>Chargement…
                </div>
            </div>
