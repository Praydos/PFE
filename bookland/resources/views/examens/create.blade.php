...
.dlg-modal-body { padding: 1.5rem; font-size: 0.9rem; line-height: 1.5; color: var(--text-primary); white-space: pre-wrap; word-break: break-word; }
...
@media (max-width: 768px) {
    ...
    .fp-footer, .card-footer, .card-actions { flex-direction: column-reverse; }
...
<div class="zn-page">
    ...
    <div class="zn-header">
        <h1>Nouvelle demande d'examen</h1>
        {{-- <p>Créez une demande pour un examen</p> --}}
    </div>
    ...
    <div class="zn-card">
        ...
        <div class="zn-card-body">
            <form method="POST" action="{{ route('examens.store') }}">
                ...
                <div class="fp-footer" style="margin-top: 2rem; padding: 0; background: none; border: none;">
