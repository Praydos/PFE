    ...
    <div class="tch-pg">
        ...
        <nav class="tch-bc" aria-label="Fil d'Ariane">
            <a href="{{ route('adoptions.index') }}">
                <svg class="tch-icon" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2"
                    viewBox="0 0 24 24">
        ...
        <div class="tch-hdr">
            ...
            <div class="tch-hdr-actions">
                <a href="{{ route('adoptions.print', $adoption) }}" target="_blank" class="btn-tch btn-tch-ghost"
        ...
        <div class="tch-card">
            ...
            <div class="tch-info-grid">
                ...
                <div class="tch-info-row">
                    ...
                    <span class="tch-info-val">{{ $adoption->product->titre }}
                        ({{ $adoption->product->isbn_13 ?? $adoption->product->isbn_10 }})</span>
                </div>
                <div class="tch-info-row">
                ...
                @if($adoption->bssLigne)
                    <div class="tch-info-row">
                        ...
                        <span class="tch-info-val">
                            <a href="{{ route('bss.show', $adoption->bssLigne->bss) }}"
