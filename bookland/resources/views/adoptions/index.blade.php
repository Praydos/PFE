                        ...
                        @forelse($adoptions as $a)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <small
                                        style="color:var(--text-muted); font-size:0.7rem;">{{ $a->product->isbn_13 ?? $a->product->isbn_10 }}</small>
                                </td>
                                ...
                                <td>
                                    <div class="actions-cell">
                                        ...
                                        <form action="{{ route('adoptions.destroy', $a) }}" method="POST"
                                            style="display:inline;" onsubmit="return confirm('Supprimer cette adoption ?')">
                                            @csrf @method('DELETE')
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="zn-empty">
                                        ...
                                        <p>{{ request('compte_id') || request('annee_scolaire_id') || request('delegue_id') ? 'Aucune adoption pour les filtres sélectionnés.' : 'Commencez par créer une nouvelle adoption.' }}
                                        </p>
                                    </div>
                                </td>
                            </tr>
