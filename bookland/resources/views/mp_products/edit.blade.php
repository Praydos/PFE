...
<div class="zn-page">
    ...
    {{-- Breadcrumb --}}
    <div class="zn-bc">
        <a href="{{ route('mp-products.index') }}">
        ...
        <span class="zn-bc-sep">›</span>
        <span class="zn-bc-cur">{{ $product->code_article }}</span>
    </div>

    <div class="zn-header">
        <h1>Modifier l’article MP</h1>
    ...
    <div class="fp-card">
        <form method="POST" action="{{ route('mp-products.update', $product) }}">
            @csrf
            @method('PUT')
            ...
            <div class="fp-section">
                <div class="fp-section-head">
                    ...
                    <div class="fp-section-meta">
                        ...
                        <div class="fp-section-sub">Code article, éditeur, nom et description</div>
                    </div>
                </div>

                {{-- Code article --}}
                <div class="frm-group">
                    <label class="frm-label" for="code_article">Code article <span class="req">*</span></label>
                    <input type="text" name="code_article" id="code_article"
                           class="frm-input @error('code_article') is-invalid @enderror"
                           value="{{ old('code_article', $product->code_article) }}" maxlength="100" required>
                    @error('code_article')<span class="frm-error">{{ $message }}</span>@enderror
                </div>
                ...
                <div class="frm-group">
                    ...
                    <div class="frm-select-wrap">
                        <select name="editeur" id="editeur" class="frm-select @error('editeur') is-invalid @enderror" required>
                            <option value="">— Choisir —</option>
                            <option value="Bookland" @selected(old('editeur', $product->editeur) == 'Bookland')>Bookland</option>
                            <option value="Esprit du livre" @selected(old('editeur', $product->editeur) == 'Esprit du livre')>Esprit du livre</option>
                        </select>
                    </div>
                ...
                <div class="frm-group">
                    ...
                    <input type="text" name="nom" id="nom"
                           ...
                           value="{{ old('nom', $product->nom) }}" maxlength="255" required>
                ...
                <div class="frm-group">
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="frm-textarea @error('description') is-invalid @enderror">{{ old('description', $product->description) }}</textarea>
