...
<div class="zn-page" style="max-width:640px;margin:0 auto;padding:2rem;">
    ...
    <h1 style="font-size:1.45rem;font-weight:700;margin-bottom:1.25rem;">Modifier l’article MP</h1>
    ...
    <form method="post" action="{{ route('mp-products.update', $product) }}" style="background:#fff;border:1px solid #e4e7f0;border-radius:12px;padding:1.5rem;">
        @csrf
        @method('PUT')
        @include('mp_products._form', ['product' => $product])
