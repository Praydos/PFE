...
<div class="zn-page">
    ...
    <div class="fp-card">
        <form method="POST" action="{{ route('mp-products.store') }}">
            @csrf
            ...
            <div class="fp-section">
                ...
                <div class="frm-group">
                    ...
                    <input type="text" name="code_article" id="code_article"
                           ...
                           value="{{ old('code_article') }}" maxlength="100" required>
                ...
                <div class="frm-group">
                    ...
                    <div class="frm-select-wrap">
                        <select name="editeur" id="editeur" class="frm-select @error('editeur') is-invalid @enderror" required>
                            ...
                            <option value="Bookland" @selected(old('editeur') == 'Bookland')>Bookland</option>
                            <option value="Esprit du livre" @selected(old('editeur') == 'Esprit du livre')>Esprit du livre</option>
                        </select>
                    </div>
                ...
                <div class="frm-group">
                    ...
                    <input type="text" name="nom" id="nom"
                           ...
                           value="{{ old('nom') }}" maxlength="255" required>
                ...
                <div class="frm-group">
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="frm-textarea @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
