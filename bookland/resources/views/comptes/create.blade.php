...
<style>
/* Copy the exact full CSS from the quartier example (or the same we used before) */
/* For brevity, paste the complete style block here – same as in previous views */
...
<div class="form-page">
    ...
    <div class="fp-bc">
        ...
        <span class="fp-bc-sep">›</span>
        <span class="fp-bc-cur">Nouveau compte</span>
    </div>
...
<script>
    ...
    function filterZones() {
        ...
        // Trigger change to reset quartier filter
        zoneSelect.dispatchEvent(new Event('change'));
    }
    villeSelect.addEventListener('change', filterZones);
    filterZones(); // run on load
    ...
    function filterDelegates() {
        ...
        // If previously selected delegate is no longer valid, clear selection
