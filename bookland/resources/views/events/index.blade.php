...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <a href="#">Gestion</a>
        <span class="zn-bc-sep">›</span>
        <span class="zn-bc-cur">Événements</span>
    </div>
    ...
    <div class="zn-header">
        ...
        <div class="zn-header-actions">
            <a href="{{ route('events.create') }}" class="btn-zn btn-zn-primary">
    ...
    <div class="zn-search-bar">
        <form method="GET" action="{{ route('events.index') }}" style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: flex-end;">
            ...
            <div class="zn-filter-group">
                <label class="zn-filter-label">Éditeur</label>
                <div class="frm-select-wrap">
                    <select name="editeur" class="zn-select">
            ...
            <div class="zn-filter-group">
                <label class="zn-filter-label">Ville</label>
                <div class="frm-select-wrap">
                    <select name="ville_id" class="zn-select">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('events.index') }}" class="btn-zn btn-zn-sm btn-zn-danger-ghost">
    ...
    <div class="zn-card">
        <div class="zn-card-header">
            ...
            <span class="zn-count">{{ $events->total() }} événement(s)</span>
        </div>
            ...
            <table class="zn-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $e->ville->nom }}</td>
                        <td>
                            <a href="{{ route('events.statistics', $e) }}" class="btn-zn btn-zn-sm btn-zn-info">
                                <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <td>
                            <div class="actions-cell">
                                <a href="{{ route('events.show', $e) }}" class="btn-zn btn-zn-sm btn-zn-info">
                                    <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                ...
                                @if(in_array(auth()->user()->role, ['admin','rbo']) || (auth()->user()->role === 'delegue' && $e->delegue_id === auth()->id()))
                                    <a href="{{ route('events.edit', $e) }}" class="btn-zn btn-zn-sm btn-zn-warning">
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="zn-empty">
                                    ...
                                    <p>{{ request('type') || request('editeur') || request('ville_id') || request('delegue_id') ? 'Aucun résultat pour les filtres sélectionnés.' : 'Commencez par créer un événement.' }}</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
