...
<style>
    ...
    /* Paste the full CSS from the "exact style" here (same as in events index) */
    /* For brevity, we assume it's included – copy the full block from the previous answer */
...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <span class="zn-bc-sep">›</span>
        <span class="zn-bc-cur">Nouvel événement</span>
    </div>
