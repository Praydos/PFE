...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-zn-danger { background: var(--rose); color: #fff; border-color: var(--rose); box-shadow: 0 4px 14px rgba(232,80,106,.35); }
    .btn-zn-danger:hover { background: #d7445c; color: #fff; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(232,80,106,.4); }
