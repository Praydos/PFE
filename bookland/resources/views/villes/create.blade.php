...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <span class="zn-bc-sep">›</span>
        <span class="zn-bc-cur">Nouvelle ville</span>
    </div>

    <div class="zn-header">
        <h1>Créer une ville</h1>
        <p>Remplissez les informations ci‑dessous pour ajouter une nouvelle ville.</p>
    </div>
    ...
    <div class="fp-card">
        <form method="POST" action="{{ route('villes.store') }}" novalidate>
            @csrf
