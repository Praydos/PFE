...
<div class="form-page">
    ...
    <div class="fp-header">
        ...
        <p>Mettez à jour les informations du quartier <strong>{{ $quartier->nom }}</strong></p>
    </div>
    ...
    <div class="fp-card">
        <div class="fp-card-header">
            ...
            <span class="fp-card-title">Informations du quartier</span>
        </div>

        <form method="POST" action="{{ route('quartiers.update', $quartier) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="fp-footer">
                <a href="{{ route('quartiers.index') }}" class="btn-fp btn-fp-ghost">
