...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <span class="zn-bc-sep">›</span>
        <a href="{{ route('users.show', $user) }}">{{ $user->prenom }} {{ $user->nom }}</a>
        <span class="zn-bc-sep">›</span>
    ...
    <div class="zn-header">
        ...
        <p>Mettez à jour les informations de <strong>{{ $user->prenom }} {{ $user->nom }}</strong>.</p>
    </div>
    ...
    <div class="fp-card">
        <form method="POST" action="{{ route('users.update', $user) }}" novalidate>
            ...
            <div class="fp-section">
                <div class="fp-section-head">
                    ...
                    <div class="fp-section-meta">
                        <div class="fp-section-title">Informations de l'utilisateur</div>
                        <div class="fp-section-sub">Identité, authentification et permissions</div>
                    </div>
                </div>
            ...
            <div class="fp-footer">
                ...
                <a href="{{ route('users.index') }}" class="btn-zn btn-zn-ghost">
                    <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
