...
<style>
    /* Paste the full CSS from the quartier example here */
...
<div class="form-page">
    ...
    <div class="fp-card">
        <div class="fp-card-header">
            ...
            <span class="fp-card-title">Informations de l'utilisateur</span>
        </div>
        ...
        <form method="POST" action="{{ route('users.update', $user) }}" novalidate>
            ...
            <div class="fp-footer">
                <a href="{{ route('users.roles') }}" class="btn-fp btn-fp-ghost">
