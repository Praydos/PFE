...
@push('styles')
{{-- Same <style> block as create.blade.php — extract to a shared partial ideally --}}
<link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,400&family=DM+Mono:wght@400;500&display=swap" rel="stylesheet">
<style>
    /* === paste the identical <style> block from create.blade.php === */
    ...
    /* The only difference is title-pip color below */
    .title-pip {
        background: var(--amber);           /* blue for edit, amber for create */
...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <span class="zn-bc-sep">›</span>
        <a href="{{ route('formations.show', $formation) }}">{{ $formation->type }}</a>
        <span class="zn-bc-sep">›</span>
    ...
    <div class="zn-card">
        ...
        <form method="POST" action="{{ route('formations.update', $formation) }}" novalidate>
            @csrf
            @method('PUT')
