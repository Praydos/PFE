...
<div class="zn-page">
    ...
    {{-- Header — sits at full page width, naturally left-aligned --}}
    <div class="zn-header">
        <div class="zn-header-left">
            <h1>Nouvelle demande de formation</h1>
            <p>Créez une demande de formation pour un établissement</p>
        </div>
    </div>

    {{-- Card — constrained to 780px but starts from the left --}}
    <div class="zn-card">
        ...
        <form method="POST" action="{{ route('formations.store') }}" novalidate>
            @csrf
