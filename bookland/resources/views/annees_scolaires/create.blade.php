...
<div class="zn-page">
    ...
    <div class="zn-header">
        <h1>Nouvelle année scolaire</h1>
        <p>Remplissez les informations ci‑dessous pour créer une année scolaire.</p>
    </div>
    ...
    <div class="fp-card">
        <form method="POST" action="{{ route('annees-scolaires.store') }}" novalidate>
            @csrf
