        ...
        <nav class="sb-nav" aria-label="Navigation principale">
            ...
            <div class="sb-section">
                ...
                <a href="{{ route('mp-products.index') }}"
                   class="sb-item {{ request()->routeIs('mp-products.*') ? 'active' : '' }}"
                ...
                <a href="{{ route('events.index') }}"
                   class="sb-item {{ request()->routeIs('events.*') ? 'active' : '' }}"
                ...
                <a href="{{ route('actions.index') }}"
                   class="sb-item {{ request()->routeIs('actions.*') ? 'active' : '' }}"
                   data-label="Actions">
                    <span class="sb-item-icon">
                        <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M9 14L4 9l5-5"/>
                ...
                <a href="{{ route('agenda.index') }}"
                   class="sb-item {{ request()->routeIs('agenda.*') ? 'active' : '' }}"
                   data-label="Agenda">
                    <span class="sb-item-icon">
                        <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M9 14L4 9l5-5"/>
                ...
                <a href="{{ route('taches.index') }}"
                   class="sb-item {{ request()->routeIs('taches.*') ? 'active' : '' }}"
                   data-label="Tâches">
                    <span class="sb-item-icon">
                        <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M9 14L4 9l5-5"/>
