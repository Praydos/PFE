...
@push('styles')
    ...
    <style>
        ...
        *::after {
        ...
        .ac-multiselect:focus {
            border-color: var(--blue);
            box-shadow: 0 0 0 3px var(--blue-m);
        }

        .ac-multiselect option {
            padding: .4rem .8rem;
        }

        .ac-multiselect option:checked {
    ...
    <div class="ac-page">
        ...
        <div class="ac-bc">
            ...
            @isset($targetDelegate)
                <span class="ac-bc-s">›</span>
                <span style="color:var(--blue);font-weight:600;">Pour {{ $targetDelegate->prenom }}
                    {{ $targetDelegate->nom }}</span>
            @endisset
        </div>
        ...
        @isset($targetDelegate)
            <div
                style="display:flex;align-items:center;gap:.6rem;padding:.75rem 1.1rem;background:var(--blue-l);border:1px solid var(--blue-m);border-radius:var(--r3);margin-bottom:1.25rem;">
                <svg width="15" height="15" fill="none" stroke="var(--blue)" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                    <circle cx="12" cy="7" r="4" />
                </svg>
                <span style="font-size:.82rem;font-weight:600;color:var(--blue-d);">Vous créez cette action au nom de
                    <strong>{{ $targetDelegate->prenom }} {{ $targetDelegate->nom }}</strong>. Elle lui sera attribuée
