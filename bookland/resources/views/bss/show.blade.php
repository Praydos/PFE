    ...
    <style>
        ...
        *::after {
        ...
        .pip-violet {
            ...
            box-shadow: 0 0 0 3px rgba(124, 111, 205, .2);
        }
    ...
    <div class="zn-page">
        ...
        <div class="zn-header">
            ...
            <div style="display:flex;align-items:center;gap:.6rem;flex-wrap:wrap;">
                <a href="{{ route('bss.print', $bss) }}" target="_blank" class="btn-zn btn-zn-ghost">
            ...
            <div>
                    ...
                    <div class="zn-card-body">
                        <div class="sv-info-grid">
                            ...
                            <div class="sv-info-item">
                                ...
                                <span
                                    class="sv-info-value {{ $bss->moyen_contact ? '' : 'muted' }}">{{ $bss->moyen_contact ?? '—' }}</span>
                            </div>
                            ...
                            <div class="sv-info-item">
                                ...
                                <span class="sv-info-value">
                                    ...
                                    <span class="dr-badge bd-none"
                                        style="margin-left:.4rem;vertical-align:middle;">{{ $bss->recupere_par_type }}</span>
                                </span>
                            </div>
                ...
                @if($bss->motif_refus || $bss->feedback)
                    <div class="zn-card">
                        <div class="zn-card-header">
                            <div class="zn-card-header-left">
                                <span class="zn-card-pip {{ $bss->motif_refus ? 'pip-rose' : 'pip-teal' }}"
                                    style="{{ $bss->motif_refus ? 'background:var(--rose);box-shadow:0 0 0 3px rgba(232,80,106,.15)' : '' }}"></span>
                        ...
                        <div class="zn-card-body">
                            ...
                            @if($bss->feedback)
                                <div class="{{ $bss->motif_refus ? 'mt-3' : '' }}">
                                    <div
                                        style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:var(--text-hint);margin-bottom:.5rem;">
                                        Feedback
                                        @if($bss->date_feedback)
                                            — <span
                                                style="font-style:normal;font-weight:500;color:var(--text-muted);">{{ \Carbon\Carbon::parse($bss->date_feedback)->format('d/m/Y') }}</span>
                                        @endif
                                    </div>
                                    <p style="font-size:.85rem;color:var(--text-secondary);line-height:1.6;">{{ $bss->feedback }}
                                    </p>
                                </div>
                            @endif
                        </div>
                ...
                <div class="zn-card">
                    <div class="zn-card-header">
                        ...
                        <span style="font-size:.75rem;color:var(--text-muted);font-weight:500;">{{ $bss->lignes->count() }}
                            ligne{{ $bss->lignes->count() > 1 ? 's' : '' }}</span>
                    </div>
                                        ...
                                        <td>
                                            <div class="tbl-actions">
                                                @if($ligne->statut_ligne === 'livree' && !$ligne->adoption)
                                                    <a href="{{ route('adoptions.convert', $ligne) }}"
                                                        class="btn-zn btn-zn-sm btn-zn-primary">
                ...
                <div class="sv-side-card">
                    ...
                    <div class="sv-side-body">
                        ...
                        <div class="sv-quick-row">
                            ...
                            <span class="sv-quick-val {{ $bss->date_livraison_prevue ? '' : 'muted' }}"
                                style="{{ !$bss->date_livraison_prevue ? 'color:var(--text-hint)' : '' }}">
                        ...
                        @if($bss->date_feedback)
                            <div class="sv-quick-row">
                                ...
                                <span
                                    class="sv-quick-val">{{ \Carbon\Carbon::parse($bss->date_feedback)->format('d/m/Y') }}</span>
                            </div>
                        @endif
                    </div>
                </div>
                            ...
                            @foreach($statuts as $i => $st)
                                ...
                                <li class="sv-tl-item">
                                    <div class="sv-tl-dot {{ $dotClass }}">
                                        @if($dotClass === 'done')
                                            <svg width="10" height="10" fill="none" stroke="#fff" stroke-width="2.5"
                                                viewBox="0 0 24 24">
                                                <polyline points="20 6 9 17 4 12" />
                                            </svg>
                ...
                <div class="sv-side-card">
                    ...
                    <div class="sv-side-body" style="display:flex;flex-direction:column;gap:.6rem;">
                        ...
                        @if($bss->statut === 'livre' && auth()->user()->role === 'delegue' && $bss->delegate_id === auth()->id())
                            <a href="{{ route('retours.create', $bss) }}" class="btn-zn btn-zn-warning"
                                style="justify-content:center;">
                                <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
