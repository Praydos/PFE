    ...
    <style>
        ...
        *::after {
        ...
        .zn-alert-danger {
            ...
            border-color: rgba(232, 80, 106, .25);
            color: #b83450;
        }
...
@section('content')
    <div class="zn-page">
        ...
        <div class="zn-bc">
            ...
            <span class="zn-bc-sep">›</span>
            <a href="{{ route('bss.show', $bss) }}">{{ $bss->numero }}</a>
            <span class="zn-bc-sep">›</span>
                ...
                <div class="fp-section">
                    ...
                    <div class="frm-group">
                        ...
                        <textarea name="feedback" id="feedback"
                            class="frm-input {{ $errors->has('feedback') ? 'is-invalid' : '' }}"
                            rows="4">{{ old('feedback', $bss->feedback) }}</textarea>
                    ...
                    <div class="frm-group">
                        ...
                        <div class="frm-select-wrap">
                            <select name="controle_document" id="controle_document"
                                class="frm-select {{ $errors->has('controle_document') ? 'is-invalid' : '' }}">
                                <option value="">— Sélectionnez —</option>
                                <option value="OK" {{ old('controle_document', $bss->controle_document) == 'OK' ? 'selected' : '' }}>OK</option>
                                <option value="Absence signature" {{ old('controle_document', $bss->controle_document) == 'Absence signature' ? 'selected' : '' }}>Absence signature
                                </option>
                                <option value="Absence cachet" {{ old('controle_document', $bss->controle_document) == 'Absence cachet' ? 'selected' : '' }}>Absence cachet</option>
                                <option value="Absence Document" {{ old('controle_document', $bss->controle_document) == 'Absence Document' ? 'selected' : '' }}>Absence Document
                                </option>
                            </select>
                        </div>
