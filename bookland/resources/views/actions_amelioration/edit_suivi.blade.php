...
<div class="zn-page">
    ...
    <div class="zn-bc">
        ...
        <span class="zn-bc-sep">›</span>
        <span class="zn-bc-cur">Ajouter le suivi</span>
    </div>

    <div class="zn-header">
        <h1>Ajouter le suivi</h1>
            ...
            <div class="fp-section">
                <div class="fp-section-head">
                    ...
                    <div class="fp-section-meta">
                        <div class="fp-section-title">Suivi de l'action</div>
                        <div class="fp-section-sub">Vérification, responsable et date</div>
                    </div>
                </div>

                {{-- Vérification mise en œuvre --}}
                <div class="frm-group">
                    <label class="frm-label" for="verification_mise_en_oeuvre">Vérification mise en œuvre</label>
                    <textarea name="verification_mise_en_oeuvre" id="verification_mise_en_oeuvre"
                              class="frm-textarea @error('verification_mise_en_oeuvre') is-invalid @enderror"
                              rows="2">{{ old('verification_mise_en_oeuvre', $actions_amelioration->verification_mise_en_oeuvre) }}</textarea>
                    @error('verification_mise_en_oeuvre')<span class="frm-error">{{ $message }}</span>@enderror
                </div>

                {{-- Responsable suivi + Date suivi (2 columns) --}}
                <div class="fp-row fp-row-2">
                    <div class="frm-group">
                        <label class="frm-label" for="responsable_suivi_id">Responsable suivi <span class="req">*</span></label>
                        <div class="frm-select-wrap">
                            <select name="responsable_suivi_id" id="responsable_suivi_id"
                                    class="frm-select @error('responsable_suivi_id') is-invalid @enderror" required>
                        ...
                        @error('responsable_suivi_id')<span class="frm-error">{{ $message }}</span>@enderror
                    </div>

                    <div class="frm-group">
                        <label class="frm-label" for="date_suivi">Date suivi</label>
                        <input type="date" name="date_suivi" id="date_suivi"
                               class="frm-input @error('date_suivi') is-invalid @enderror"
                               value="{{ old('date_suivi', $actions_amelioration->date_suivi ? $actions_amelioration->date_suivi->format('Y-m-d') : '') }}">
                        @error('date_suivi')<span class="frm-error">{{ $message }}</span>@enderror
                    </div>
                </div>
            </div>
