            ...
            <form method="GET" action="{{ route('actions-amelioration.index') }}">
                <div class="aa-filter-row">
                    ...
                    @if(in_array(auth()->user()->role, ['admin', 'abo', 'rbo']))
                        <div class="aa-filter-group">
                            <label class="aa-filter-label">Délégué</label>
                            <select name="delegue_id" class="aa-select">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="aa-actions">
                                        <a href="{{ route('actions-amelioration.show', $a) }}"
                                            class="btn-aa btn-aa-sm btn-aa-info">
                                        ...
                                        @if(auth()->user()->role !== 'rbo')
                                            <a href="{{ route('actions-amelioration.edit', $a) }}"
                                                class="btn-aa btn-aa-sm btn-aa-warning">
                                                <svg width="11" height="11" fill="none" stroke="currentColor" stroke-width="2.2"
                                                    viewBox="0 0 24 24">
                                        ...
                                        @if(auth()->user()->role === 'admin')
                                            <form method="POST" action="{{ route('actions-amelioration.destroy', $a) }}"
                                                style="display:inline;" onsubmit="return confirm('Supprimer cette action ?')">
                                                @csrf
                                                @method('DELETE')
