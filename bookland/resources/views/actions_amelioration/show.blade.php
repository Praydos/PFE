...
@push('styles')
    ...
    <style>
        ...
        *::after {
        ...
        .aa-section:nth-child(1) {
            animation-delay: .05s;
        }

        .aa-section:nth-child(2) {
            animation-delay: .10s;
        }

        .aa-section:nth-child(3) {
            animation-delay: .15s;
        }

        .aa-section:nth-child(4) {
            animation-delay: .20s;
        }
...
@section('content')
    <div class="aa-page">
        ...
        <div class="aa-section">
            ...
            <div class="aa-info-grid">
                ...
                @if(in_array(auth()->user()->role, ['admin', 'rbo', 'abo']))
                    <div class="aa-info-item">
                        <span class="aa-info-label">Délégué</span>
                        <span class="aa-info-value">{{ optional($actions_amelioration->compte->delegue)->prenom }}
                            {{ optional($actions_amelioration->compte->delegue)->nom }}</span>
                    </div>
                @endif
                <div class="aa-info-item">
                    <span class="aa-info-label">Émetteur</span>
                    <span class="aa-info-value">{{ $actions_amelioration->emetteur->prenom }}
                        {{ $actions_amelioration->emetteur->nom }}</span>
                </div>
                <div class="aa-info-item">
            ...
            <div class="aa-section">
                ...
                <div class="aa-info-grid">
                    <div class="aa-info-item">
                        ...
                        <span class="aa-info-value">{{ $actions_amelioration->responsableSuivi->prenom }}
                            {{ $actions_amelioration->responsableSuivi->nom }}</span>
                    </div>
                    <div class="aa-info-item">
        ...
        <div class="aa-footer">
            ...
            <a href="{{ route('actions-amelioration.pdf', $actions_amelioration) }}" target="_blank"
                class="btn-aa btn-aa-ghost">
                <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
